...
export default async function AnalyticsPage({
  ...
  // Await searchParams to ensure asynchronous access and schema parsing
  const parsedSearchParams = await searchParamsSchema.parseAsync(
    await searchParams,
  );
  const { page, from, to } = parsedSearchParams;
